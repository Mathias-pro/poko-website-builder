...
{% image src="/_images/1-collaborateur.webp", width="1200" %}

D) Cherche le compte de ton collaborateur dans le champ de recherche et ajoute le.

{% image src="/_images/2-collaborateur.webp", width="500" %}

{% image src="/_images/3-collaborateur.webp", width="500" %}

Tu verras un bandeau de confirmation en haut de ta page si l'invitation est bien partie.

{% image src="/_images/4-validation.webp", width="1200" %}
